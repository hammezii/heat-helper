...
`heat_helper` is used daily and is likely to be updated frequently. Contributions or ideas for new functions are welcome; please get in touch via [GitHub](https://github.com/hammezii/heat-helper). 
